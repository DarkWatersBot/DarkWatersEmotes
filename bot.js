...
client.on('message', message => {
	if(message.author.bot){
		...
		if (message.content.includes('//sweat')){
			...
			message.channel.send(attachment);
		}else if (message.content.includes('//renablush')){
			const attachment = new Attachment('https://1.bp.blogspot.com/-fgyfgdNZbLQ/XUzes5NKGmI/AAAAAAAAAVU/FiOE6WIkfZYUex_QGOiE3stWk_DXwRxGwCLcBGAs/s1600/RenaBlush.png');
			message.channel.send(attachment);
